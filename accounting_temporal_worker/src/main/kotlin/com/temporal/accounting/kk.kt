...
object HelloActivity {
    ...
    const val WORKFLOW_ID: String = "HelloActivityWorkflow"
     ...
     */
    @JvmStatic
    fun main55555(args: Array<String>) {
    ...
    internal class GreetingActivitiesImpl : GreetingActivities {
        ...
        companion object {
            private val log: Logger = LoggerFactory.getLogger(GreetingActivitiesImpl::class.java)
        }
    }
}