...
impl CessStrategy {
    pub fn get_strategy_name(&self) -> &'static str {
        match self {
            CessStrategy::PercentageOfAssessableValue { .. } => "percentage_of_assessable_value",
            CessStrategy::AmountPerUnit { .. } => "amount_per_unit",
            ...
            CessStrategy::PercentageOfRetailSalePrice { .. } => "percentage_of_retail_sale_price",
        }
    }
    pub fn new(
        strategy_name: &str,
        ...
        let strategy = match strategy_name {
            "percentage_of_assessable_value" => CessStrategy::PercentageOfAssessableValue {
                cess_rate_percentage,
            },
            "amount_per_unit" => CessStrategy::AmountPerUnit {
            ...
            "percentage_of_retail_sale_price" => CessStrategy::PercentageOfRetailSalePrice {
                cess_rate_percentage,
                retail_sale_price,
            },
            _ => bail!(
                "{} does not match any cess calculation strategy",
                strategy_name
            ),
        };
        Ok(strategy)
...
mod tests {
    ...
    fn test_percentage_of_assessable_value(
        #[case] strategy: CessStrategy,
        #[case] taxable_value: f64,
        #[case] quantity: f64,
        #[case] expected_cess_amount: f64,
    ) {
    ...
    fn test_percentage_of_assessable_value_and_amount_per_unit(
        #[case] strategy: CessStrategy,
        #[case] taxable_value: f64,
        #[case] quantity: f64,
        #[case] expected_cess_amount: f64,
    ...
    fn test_max_of_percentage_of_assessable_value_and_amount_per_unit(
        #[case] strategy: CessStrategy,
        #[case] taxable_value: f64,
        #[case] quantity: f64,
        #[case] expected_cess_amount: f64,
    ...
    fn test_percentage_of_retail_sale_price(
        #[case] strategy: CessStrategy,
        #[case] taxable_value: f64,
        #[case] quantity: f64,
        #[case] expected_cess_amount: f64,
