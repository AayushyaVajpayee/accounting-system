...
pub mod tests {
    ...
    use crate::masters::product_item_master::product_item_models::{
        CessTaxRateResponse, CessTaxRateResponseBuilder, ProductCreationRequest,
        ProductCreationRequestBuilder, ProductItemResponse, ProductItemResponseBuilder,
    ...
    pub fn a_product_creation_request(
        ...
        ProductCreationRequest {
            ...
            line_title: builder
                .line_title
                .unwrap_or_else(|| LineTitle::new(title).unwrap()),
            line_subtitle: builder.line_subtitle.flatten(),
            hsn_sac_code: builder
                .hsn_sac_code
    ...
    pub fn a_product_item_response(builder: ProductItemResponseBuilder) -> ProductItemResponse {
        ProductItemResponse {
            ...
            temporal_tax_rates: builder
                .temporal_tax_rates
                .unwrap_or(vec![a_product_tax_rate_response(Default::default())]),
            temporal_cess_rates: builder
                .temporal_cess_rates
                .unwrap_or(vec![a_cess_rate_response(Default::default())]),
    ...
    fn a_product_tax_rate_response(
        builder: ProductTaxRateResponseBuilder,
    ) -> ProductTaxRateResponse {
        ProductTaxRateResponse {
            tax_rate_percentage: builder
                .tax_rate_percentage
                .unwrap_or(5.0.try_into().unwrap()),
            start_date: builder
                .start_date
                .unwrap_or(get_current_indian_standard_time()),
    ...
    fn a_cess_rate_response(builder: CessTaxRateResponseBuilder) -> CessTaxRateResponse {
        CessTaxRateResponse {
            cess_strategy: builder.cess_strategy.unwrap_or(
    ...
    fn test_get_tax_rate() {
        ...
        for (temporal_tax_rates, expected_tax_rate) in test_cases {
            ...
            assert_eq!(
                applicable_tax_rate.tax_rate_percentage,
                expected_tax_rate.try_into().unwrap()
            );
        }
    }
